...
<body>
	...
	<table style="width: 700px; text-align: center" border="1">
		...
		<tr>
			<td colspan="2">
				<input type="button" value="수정" onclick="location.href='6_bUpdate.jsp?num=<%=bdto.getNum()%>'">
				<input type="button" value="삭제" onclick="location.href='8_bDelete.jsp?num=<%=bdto.getNum()%>'">
				<input type="button" value="목록" onclick="location.href='4_bList.jsp'">
			</td>
		</tr>
	</table>
</body>
